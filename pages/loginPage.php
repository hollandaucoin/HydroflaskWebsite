...
@desc loginPage - This is a page that allows a user to login
        ...
        <div class="container"><a class="navbar-brand logo" href="../index.php"><img src="../assets/img/main/hydrologo.png" height="35px" width="28px" style="padding-bottom:8px">  H Y D R O F L A S K</a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                <ul class="nav navbar-nav ml-auto">
                    <li class="nav-item" role="presentation"><a class="nav-link" href="registrationPage.php">R E G I S T E R</a></li>
                </ul>
            </div>
        </div>
    </nav>
    <main class="page login-page">
        <section class="clean-block clean-form dark">
            <div class="container">
                ...
                <!-- Form to login, sends to loginHandler -->
                <form action="loginHandler.php" method="POST">
                	<?php if(isset($message)) {
				        ?><p align=center><?php echo $message?></p><?php
				    }
				    ?>	
                    <div class="form-group"><input class="form-control item" type="text" placeholder="username" name="username" id="username" required></div>
                    <div class="form-group"><input class="form-control" type="password" placeholder="password" name="password" id="password" required></div>
                    <br>
                    <button class="btn btn-primary btn-block" type="submit" name="submit">Log In</button>
                    <br>
                    <p align=center>Don't have an account? <a href="registrationPage.php">Register</a></p>
                </form>
            </div>
        </section>
    </main>
